...
if __name__ == "__main__":
    ...
    train_dir, val_dir, test_dir = split_dataset(
        os.path.join(merged_output_dir, 'images'),
        os.path.join(merged_output_dir, 'labels'),
        split_output_dir
    )
    ...
    train_yolo_model(os.path.join(split_output_dir, "data.yaml"), epochs=100, batch_size=2, learning_rate=0.001)
